			...
			<div class="spldishes-agileinfo">
				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
						<a href="{{route('show_category_dish', ['category_id'=>$dish->category_id])}}" class="item g1">
							<img class="lazyOwl" src="{{$dish->dish_image}}" width="150px" height="150px" title="Our latest gallery" alt=""/>
