...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('import_csv') }}" method="POST" enctype="multipart/form-data">
            ...
            <br>
            <button class="btn btn-success" name="import_csv"><i class="fas fa-file-import"></i> Import Dish Data</button>
            <a class="btn btn-warning" href="{{ route('export_csv') }}" name="export_csv"><i class="fas fa-file-export"></i> Export Dish Data</a>
        </form>
    </div>
</div>
@endsection